...
let userID = "fafeeae8-a1d4-442e-8895-a742d9c32c80";
...
function getVLESSConfig(userID, hostName) {
  ...
  const note = `??????:https://ygkkk.blogspot.com\n??YouTube??:https://www.youtube.com/@ygkkk\n??TG????:https://t.me/ygkkktg\n??TG????:https://t.me/ygkkktgpd\n\nProxyIP?????:${proxyIP}`;
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Cloudflare-workers/pages-vless???? V24.7.25</h1>
	    <hr>
            <p>${noteshow}</p>
            <hr>
	    <hr>
	    <hr>
			...
			<table class="table">
				...
				<tbody>
					<tr>
						...
						<td><button class="btn btn-primary" onclick="copyToClipboard('${wvlessws}')">??????</button></td>
					</tr>
				</tbody>
			</table>
            <h5>???????:</h5>
            <ul>
                <li>?????(address):?????? ?? ???? ?? ??IP ?? ??IP</li>
                <li>??(port):7?http???????(80?8080?8880?2052?2082?2086?2095),???IP????</li>
                <li>??ID(uuid):${userID}</li>
		...
		<li>????(TLS):??</li>
			...
			<table class="table">
				...
				<tbody>
					<tr>
						<td class="limited-width">???TLS??,<br>?????????(Fragment)??,????,??????</td>
						<td class="limited-width">${pvlesswstls}</td>	
						<td><button class="btn btn-primary" onclick="copyToClipboard('${pvlesswstls}')">??????</button></td>
					</tr>
				</tbody>
			</table>
            <h5>???????:</h5>
            <ul>
                <li>?????(address):?????? ?? ???? ?? ??IP ?? ??IP</li>
                <li>??(port):6?https???????(443?8443?2053?2083?2087?2096),???IP????</li>
                <li>??ID(uuid):${userID}</li>
                <li>????(network):ws ?? websocket</li>
                <li>????(host):${hostName}</li>
                <li>??(path):/?ed=2560</li>
			...
			<br>	
			<br>
			<h3>3:?????Clash-meta?Sing-box??????:</h3>
			<hr>
			<p>??:<br>1???????????TLS+?TLS?13?????<br>2???workers????????,???????????<br>3???????????????,?TLS?????</p>
			<hr>
			<table class="table">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="copyToClipboard('${ty}')">??????</button></td>
						</tr>
					</tbody>
				</table>	
				...
				<table class="table">
						...
						<tbody>
							<tr>
								...
								<td><button class="btn btn-primary" onclick="copyToClipboard('${cl}')">??????</button></td>
							</tr>
						</tbody>
					</table>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="copyToClipboard('${sb}')">??????</button></td>
						</tr>
					</tbody>
				</table>
				<br>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <br>
            <br>
            <h3>1:CF-pages/workers/????-vless+ws+tls??</h3>
			<table class="table">
				<thead>
					<tr>
						<th>????:</th>
			...
			<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="copyToClipboard('${pty}')">??????</button></td>
						</tr>
					</tbody>
				</table>	
				...
				<table class="table">
						...
						<tbody>
							<tr>
								...
								<td><button class="btn btn-primary" onclick="copyToClipboard('${pcl}')">??????</button></td>
							</tr>
						</tbody>
					</table>
					...
					<tbody>
						<tr>
							...
							<td><button class="btn btn-primary" onclick="copyToClipboard('${psb}')">??????</button></td>
						</tr>
					</tbody>
				</table>
				<br>
